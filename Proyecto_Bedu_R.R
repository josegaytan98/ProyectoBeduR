...
ggplot(data, aes(x = weather, y = precipitation)) + 
  geom_boxplot() + 
  labs(title = "Boxplot de Precipitation por Condición Meteorológica", x = "Condición Meteorológica", y = "Precipitation") +
  theme_minimal()

ggplot(data, aes(x = weather, y = temp_max)) + 
  geom_boxplot() + 
  labs(title = "Boxplot de Temp Max por Condición Meteorológica", x = "Condición Meteorológica", y = "Temp Max") +
  theme_minimal()

ggplot(data, aes(x = weather, y = temp_min)) + 
  geom_boxplot() + 
  labs(title = "Boxplot de Temp Min por Condición Meteorológica", x = "Condición Meteorológica", y = "Temp Min") +
  theme_minimal()

ggplot(data, aes(x = weather, y = wind)) + 
  geom_boxplot() + 
  labs(title = "Boxplot de Wind por Condición Meteorológica", x = "Condición Meteorológica", y = "Wind") +
  theme_minimal()
